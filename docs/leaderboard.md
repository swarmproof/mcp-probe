...
> Scored with **mcp-quality 0.1.0** (rubric `2026.07.1`). Fast path (Contract + Cost) + Security-lite. Keyless, offline-deterministic. Servers requiring API keys are listed but not scored.
