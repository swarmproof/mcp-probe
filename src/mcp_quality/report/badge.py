...
def shields_endpoint(grade: str, *, label: str = "mcp-quality") -> dict[str, object]:
...
def badge_svg(
    grade: str,
    *,
    label: str = "mcp-quality",
    rubric_version: str = "",
    score: float | None = None,
) -> str:
    """A flat shields-style SVG. ``score`` (if given) renders ``mcp-quality: A · 92``."""
...
def shields_endpoint_json(grade: str, *, label: str = "mcp-quality") -> str:
